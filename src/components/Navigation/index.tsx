...
const NavLink: React.FC<NavLinkProps> = ({
    ...
    return (
        ...
        }} className={`text-sm md:text-xl rounded-lg p-3 button-disabled text-300 flex gap-3 md:justify-between items-center transition-all ${document.location.pathname === link ? "button-active" : ""}`}>
            {children}
        </Link>
    )
}
...
interface Navigation {
    hamburgerClose?: () => void;
    resBiggestTX?:ItemDataType | null
}

const Navigation: React.FC<Navigation> = ({ hamburgerClose,resBiggestTX }) => {
    ...
    return (
        <div>
            ...
            {resBiggestTX && (<>
                    <span className="biggest_tr_title">Biggest fiat tx of today:</span>
                    <ColumnElement item={resBiggestTX} />
            </>)}
            </div>
            <h1 className="text-gray-300 text-title mb-5 lg:text-xl 2xl:text-2xl relative">
            ...
            <div className='flex md:flex-col gap-3'>
                <NavLink link='/' hamburgerClose={hamburgerClose}>
                    <span>Tracker</span>
                    <svg className='svgColor w-5 h-5' xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                        <g clipPath="url(#clip0_613_40)">
                            <path d="M7.44634 14.5209L10.3778 10.0147C10.3778 10.0147 5.9989 8.27519 3.95908 9.83437C1.91931 11.3944 0.000366211 15.7139 0.000366211 15.7139L2.17472 16.9746C2.17472 16.9746 4.92681 11.6416 7.44634 14.5209Z" fill="#F1F1F1" />
                            <path d="M15.4791 22.5538L19.9853 19.6223C19.9853 19.6223 21.7248 24.0012 20.1657 26.0411C18.6056 28.0799 14.2861 29.9998 14.2861 29.9998L13.0264 27.8255C13.0264 27.8255 18.3593 25.0733 15.4791 22.5538Z" fill="#F1F1F1" />
                            <path d="M12.1108 21.2629L11.3372 20.4902C9.93095 24.145 6.62773 23.3723 6.62773 23.3723C6.62773 23.3723 5.855 20.0691 9.50984 18.6628L8.7371 17.8901C6.69822 17.5385 4.09718 19.9985 3.67513 22.3881C3.25396 24.7776 3.18347 26.8156 3.18347 26.8156C3.18347 26.8156 5.22142 26.746 7.61187 26.3239C10.0023 25.9019 12.4624 23.3018 12.1108 21.2629Z" fill="#F1F1F1" />
                            <path d="M29.6029 0.397176C26.4132 -1.09784 18.3355 1.69813 13.843 7.65641C10.4199 12.1947 8.58789 15.2526 8.58789 15.2526L11.307 17.9717L12.0285 18.6931L14.7467 21.4114C14.7467 21.4114 17.8064 19.5803 22.3446 16.1581C28.3011 11.6646 31.098 3.5869 29.6029 0.397176ZM16.0916 13.9085C15.3408 13.1578 15.3408 11.9401 16.0916 11.1894C16.8423 10.4387 18.059 10.4387 18.8107 11.1904C19.5614 11.9411 19.5614 13.1578 18.8107 13.9086C18.059 14.6593 16.8423 14.6593 16.0916 13.9085ZM20.5987 9.40233C19.6282 8.43096 19.6282 6.85807 20.5987 5.88764C21.5683 4.91716 23.1421 4.91716 24.1125 5.88764C25.083 6.85813 25.083 8.43096 24.1125 9.40233C23.1421 10.3719 21.5683 10.3719 20.5987 9.40233Z" fill="#F1F1F1" />
                        </g>
                        <defs>
