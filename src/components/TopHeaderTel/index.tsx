        ...
        <div className="bg-white p-4 flex flex-col gap-5 h-screen">
          ...
          <div>
            ...
            <div className="flex gap-3 relative">
              ...
              <div className="w-16 h-16 mob_qr_code">
                <img src={qrCodeImg} alt="QrCode" className="" />
              </div>
            </div>
          </div>
          <div className="flex gap-3 mob_menu_icons">
            ...
            <img src={tonImg} alt="ton" className="w-7 h-7" />
            <img src={solimg} alt="sol" className="w-7 h-7" />
            <img src={xrpImg} alt="xrp" className="w-7 h-7" />
          </div>
        </div>
      )}
