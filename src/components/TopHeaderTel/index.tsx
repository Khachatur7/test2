...
const TopHeaderTel = () => {
  ...
  const [resBiggestTX, setResBiggestTX] = useState<ItemDataType | null>(null);
  ...
  const GetBiggestTxOfDay = async () => {
    ...
    if (resData) {
      ...
      const allNeedDate = `${day}.0${month + 1}.${year}`;
      let check = resData[0];
  ...
  return (
    <div className={`fixed z-10 w-full transition-all ${!isOpen ? "p-4" : ""}`}>
      <div
        className={`p-4 flex justify-between items-center bg-white transition-all relative ${
          !isOpen ? "rounded-lg" : ""
        }`}
      >
        <div className="w-48 h-auto">
          <img src={logoImg} alt="logoBigcryptotx" className="" />
          <div
            className="flex items-center gap-3 ml-auto nav_share text-white"
          ...
          {share && (
            <div
              className="nav_transaction_popup"
              onMouseLeave={CloseShare}
              onMouseMove={ShareTransaction}
            >
              <FacebookMessengerShareButton url={url} appId="1">
                <FacebookIcon className="share_bttn_icon" />
              </FacebookMessengerShareButton>
              <TelegramShareButton url={url}>
                <TelegramIcon className="share_bttn_icon" />
              </TelegramShareButton>
              <WhatsappShareButton url={url}>
                <WhatsappIcon className="share_bttn_icon" />
              </WhatsappShareButton>
              <EmailShareButton url={url}>
                <EmailIcon className="share_bttn_icon" />
              </EmailShareButton>
              <TwitterShareButton url={url}>
                <TwitterIcon className="share_bttn_icon" />
              </TwitterShareButton>
              <RedditShareButton url={url}>
                <RedditIcon className="share_bttn_icon" />
              </RedditShareButton>
              <VKShareButton url={url}>
                <VKIcon className="share_bttn_icon" />
              </VKShareButton>
              <ViberShareButton url={url}>
                <ViberIcon className="share_bttn_icon" />
              </ViberShareButton>
              <MailruShareButton url={url}>
                <MailruIcon className="share_bttn_icon" />
              </MailruShareButton>
            </div>
          )}
        </div>
        <div
          className="w-8 h-auto p-1 bg-white rounded-lg cursor-pointer"
          onClick={toggleMenu}
        >
          <span
            className={`block w-full h-0.5 burger-menu transition-all ${
              isOpen ? "transform rotate-45" : ""
            }`}
          ></span>
          <span
            className={`block w-full h-0.5 mt-1 burger-menu transition-all ${
      ...
      {isOpen && (
        <div className="bg-white p-4 flex flex-col gap-5 h-screen">
          <Navigation hamburgerClose={closeMenu} resBiggestTX={resBiggestTX} />
          <div>
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <stop offset="0.2" stop-color="#DA9413" />
                      <stop offset="0.42" stop-color="#DA9413" />
                      <stop offset="0.67" stop-color="#DA9413" />
                      <stop offset="1" stop-color="#DA9413" />
                    </radialGradient>
                    <linearGradient
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop offset="0.16" stop-color="#FDF3E1" />
                      <stop offset="0.4" stop-color="#FEFAF2" />
                      <stop offset="0.67" stop-color="#FFFEFC" />
          ...
          <div className="flex gap-3">
            <img src={bitcoinImg} alt="bitcoin" className="w-7 h-7" />
            <img src={ethereumImg} alt="ethereum" className="w-7 h-7" />
            <img src={usdtImg} alt="usdt" className="w-7 h-7" />
            <img src={usdcImg} alt="usdc" className="w-7 h-7" />
            <img src={bnbImg} alt="bnb" className="w-7 h-7" />
            <img
              src={solimg}
              alt="bnb"
      ...
      {/* <Navigation resBiggestTX={resBiggestTX}/> */}
      {/*<div>*/}
      {/*    <p className='lg:text-2xl 2xl:text-4xl color-gold mb-5'>Subscribe<span className='color-green'> to the telegram!</span></p>*/}
      {/*    <div className='flex gap-3'>*/}
      {/*        <a*/}
      {/*            href="https://t.me/+TzNRg_I0rrAzZjgy"*/}
      {/*            target="_blank"*/}
      ...
      {/*                <g clip-path="url(#clip0_612_14)">*/}
      {/*                    <path d="M39.2141 0H14.7859C6.61988 0 0 6.61988 0 14.7859V39.2141C0 47.3801 6.61988 54 14.7859 54H39.2141C47.3801 54 54 47.3801 54 39.2141V14.7859C54 6.61988 47.3801 0 39.2141 0Z" fill="url(#paint0_radial_612_14)" fill-opacity="0.7"/>*/}
      {/*                    <path d="M26.2328 34.2273L25.4656 34.9771C24.5938 35.7792 23.8091 36.5899 22.9635 37.3833C22.618 37.7361 22.1798 37.984 21.6994 38.0982H21.5947H21.464C21.4596 38.0576 21.4596 38.0167 21.464 37.9761C21.5424 36.9038 21.6296 35.8228 21.7168 34.7417C21.7865 33.7914 21.865 32.8412 21.9347 31.8822C21.9347 31.6119 21.9783 31.3329 22.0045 31.0627C22.019 31.0015 22.0526 30.9466 22.1004 30.9057L25.9887 27.3487L33.835 20.1999L34.8811 19.2409C34.952 19.1747 35.0163 19.1017 35.0729 19.0229C35.1776 18.8747 35.1253 18.7527 34.9509 18.7091C34.8604 18.681 34.7653 18.6711 34.671 18.6801C34.5767 18.6891 34.4852 18.7167 34.4016 18.7614C34.2591 18.8324 34.1222 18.914 33.9919 19.0055L19.0491 28.4036C18.7701 28.578 18.4998 28.7611 18.1772 28.9267C18.1009 28.9526 18.0182 28.9526 17.9418 28.9267L11.2463 26.8954C11.0198 26.8339 10.7983 26.7552 10.5838 26.66C10.4804 26.624 10.3874 26.5633 10.3128 26.4831C10.2383 26.4029 10.1845 26.3057 10.1561 26.2C10.1277 26.0943 10.1257 25.9832 10.1501 25.8765C10.1744 25.7697 10.2246 25.6706 10.2961 25.5877C10.4705 25.3278 10.7198 25.1272 11.0109 25.0123C11.6968 24.7217 12.3855 24.4311 13.0771 24.1405L24.3584 19.7814L38.3074 14.4023C38.4927 14.3288 38.6857 14.2762 38.8828 14.2454C39.2182 14.208 39.5551 14.3027 39.8219 14.5094C40.0888 14.716 40.2648 15.0185 40.3125 15.3526C40.3908 15.7263 40.3908 16.1122 40.3125 16.486C39.7371 19.1973 39.153 21.9086 38.5689 24.6287L36.616 33.6607C36.3022 35.1427 35.9971 36.6161 35.6658 38.0895C35.6033 38.3912 35.5037 38.684 35.3694 38.9613C35.3171 39.1034 35.237 39.2336 35.1339 39.3445C35.0308 39.4554 34.9067 39.5446 34.7688 39.6071C34.6309 39.6695 34.4819 39.704 34.3306 39.7083C34.1793 39.7127 34.0286 39.687 33.8873 39.6326C33.5231 39.5376 33.18 39.3749 32.876 39.1531C30.6964 37.5228 28.5169 35.9012 26.3112 34.2709L26.2328 34.2273Z" fill="url(#paint1_linear_612_14)"/>*/}
      {/*                </g>*/}
      {/*                <defs>*/}
      {/*                    <radialGradient id="paint0_radial_612_14" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(25.98 -22.9112) scale(62.7791)">*/}
      {/*                        <stop stop-color="#DA9413"/>*/}
      {/*                        <stop offset="0.2" stop-color="#DA9413"/>*/}
      {/*                        <stop offset="0.42" stop-color="#DA9413"/>*/}
      {/*                        <stop offset="0.67" stop-color="#DA9413"/>*/}
      {/*                        <stop offset="1" stop-color="#DA9413"/>*/}
      {/*                    </radialGradient>*/}
      {/*                    <linearGradient id="paint1_linear_612_14" x1="25.2563" y1="39.7197" x2="25.2563" y2="14.2716" gradientUnits="userSpaceOnUse">*/}
      {/*                        <stop offset="0.16" stop-color="#FDF3E1"/>*/}
      {/*                        <stop offset="0.4" stop-color="#FEFAF2"/>*/}
      {/*                        <stop offset="0.67" stop-color="#FFFEFC"/>*/}
      {/*                        <stop offset="1" stop-color="white"/>*/}
      ...
      {/*            </svg>*/}
      {/*        </a>*/}
      {/*        <div className='lg:w-16 lg:h-16 xl:w-48 xl:h-48'>*/}
      {/*            <img*/}
      {/*                src={qrCodeImg}*/}
      {/*                alt="QrCode"*/}
      {/*                className=""*/}
      ...
      {/*        src={bitcoinImg}*/}
      {/*        alt="bitcoin"*/}
      {/*        className="lg:w-7 lg:h-7 xl:w-10 xl:h-10"*/}
      {/*    />*/}
      {/*    <img*/}
      {/*        src={ethereumImg}*/}
      {/*        alt="ethereum"*/}
